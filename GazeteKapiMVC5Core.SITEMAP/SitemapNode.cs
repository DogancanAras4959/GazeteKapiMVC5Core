...
using GazeteKapiMVC5Core.SiteMap.Images;
using GazeteKapiMVC5Core.SiteMap.News;
using GazeteKapiMVC5Core.SiteMap.Routing;
using GazeteKapiMVC5Core.SiteMap.Serialization;
using GazeteKapiMVC5Core.SiteMap.Translations;
using GazeteKapiMVC5Core.SiteMap.Videos;
